...
const BADGES = [
	{
		...
		text: (
			<p>
				{' '}
				Simply Input your Ingredients into the Field Below and Get Started Looking up your Recipes!
			</p>
		),
	},

	{
		...
		text: <p> Save Your Favorite Meals, Click the Heart Icon Beside Each Recipe!</p>,
	},

	{
		...
		text: (
			<p> Search for any Recipe, specify by Allergens, or by any ingredient, we have it all! </p>
		),
	},
];
	...
	return (
		<div className='banner-container'>
			<div className='top-container'>
				<h1 className='top-container-header'> This is where we place our badges </h1>
				<p className='top-container-paragraph'>
					We can put some quick instructions here, something to break up the page, it can be out
					features, what we aim to do, whatever. Everything is currently replaceable - new icons,
					new layout - ish
				</p>
			</div>
