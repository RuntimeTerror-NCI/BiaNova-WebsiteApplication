...
function SearchSection() {
  ...
  return (
    <SearchContainer>
      ...
      <p>
        Some Random Recipes to show you how we get down! If you like what you
        see and can't wait to get started, start searching here! Or Scroll Up
        and Become a User and earn the right to save to Favorites! .{" "}
      </p>
